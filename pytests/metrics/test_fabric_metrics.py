...
def test_port_metrics_response():
    ...
    port_metric_response1 = metric_response.port_metrics.metrics.add(port_name='ToR Switch 1.1 Port 10')
    ...
    port_metric_response2 = metric_response.port_metrics.metrics.add(port_name='ToR Switch 1.1 Port 1')
